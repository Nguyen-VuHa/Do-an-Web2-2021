...
const ProgressBarItem: React.FC<ProgressBarItemProps> = ({
  ...
  return (
    <li className={`group relative w-full h-[72px] flex justify-between items-center`}>
        <div 
        ...
        {
            !iconHidden &&  <svg fill="none" viewBox="0 0 22 80" preserveAspectRatio="none" 
            className={`
                h-full
            ...
            `
            }><path d="M0 -2L20 40L0 82" vectorEffect="non-scaling-stroke" strokeLinejoin="round"></path></svg>
        }
    </li>
  )
}
