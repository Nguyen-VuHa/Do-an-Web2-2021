  ...
  return (
    <div className="flex flex-col space-y-4">
      <div className="flex items-end space-x-2">
        <Image src={StarPoint} alt="NO IMAGE" width={40} height={40} />
        <span
          className={`font-semibold text-2xl text-social-x ${isLoading ? "bg-second rounded-circle-md animate-pulse !text-transparent" : ""}`}
        >
          Chi tiết
        </span>
      </div>
      ...
      {isLoading && (
        <div className="flex flex-col space-y-2">
          <span
            className="bg-second rounded-circle-md animate-pulse"
