export const REDIS_MOVIE_TOP_WEEK_KEY = 'movie_top_week';
export const REDIS_MOVIE_TOP_WEEK_TTL = 604800; // 7 ngày

export const REDIS_MOVIE_CLIENT_KEY = 'movie_client';
export const REDIS_MOVIE_CLIENT_TTL = 86400; // 1 ngày
...
export const REDIS_SHOWTIME_BY_MOVIE_KEY = 'showtime_by_movie';
export const REDIS_SHOWTIME_BY_MOVIE_TTL = 3600; // 1 giờ
...
export const REDIS_USER_CLIENT_INFO_TTL = 3600; // 1 giờ

export const REDIS_SHOWTIME_DETAIL_KEY = 'showtime_detail';
export const REDIS_SHOWTIME_DETAIL_TTL = 3600; // 1 giờ
