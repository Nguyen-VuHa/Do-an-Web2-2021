  ...
  return (
    <div
      className={`fixed w-full h-full top-0 left-0 flex justify-center items-center dark:bg-boxdark/50 bg-strokedark/30 ${
        isOpen ? 'z-999999 transition-all' : 'hidden z-[-10]'
      }`}
    >
      <div
        className={`modal w-[30%] max-sm:w-[90%] rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark overflow-auto`}
      >
